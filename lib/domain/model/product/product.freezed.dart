...
class _$ProductImpl implements _Product {
  ...
  @override
  String toString() {
    return 'Product(id: $id, name: $name, price: $price, description: $description, img: $img, category: $category, asp: $asp, defaultPrice: $defaultPrice)';
  }
